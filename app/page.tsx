...
const workstreams: Workstream[] = [
  {
    ...
    items: ["New Adoption Topics", "Security", "RISE customer investment program", "SAP Micro-App Hub"],
    itemIcons: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0070F2] to-[#002A86]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10 md:pt-20 md:pb-14">
