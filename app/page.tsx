  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0070F2] to-[#002A86]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-36 md:pt-14 md:pb-40">
        ...
        {/* Bottom wave */}
        <div className="absolute left-0 right-0 leading-none translate-y-px">
          <svg className="block w-full h-auto" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            <rect x="0" y="118" width="1440" height="4" fill="#f9fafb" />
            <path
